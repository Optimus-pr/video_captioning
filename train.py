...
from keras.optimizers import Adam  # Updated this line
...
class VideoDescriptionTrain(object):
    ...
    def load_dataset(self, training_list):
        ...
        train_sequences = np.array(train_sequences, dtype=object)  # Updated this line
    ...
    def train_model(self):
        ...
        # Run training
        opt = Adam(learning_rate=config.learning_rate)  # Updated this line
