...
#         if not file_list or self.num >= len(file_list):
#             print("No more test data or index out of range.")
#             return None, None
...
#         if X_test is None or filename is None:
#             print("No more test data or index out of range.")
#             return None, None
...
#             if decoded_sentence is not None:
...
#         # Append the video ID and caption to the output.txt file
#         with open('output.txt', 'a') as output_file:
#             output_file.write(f"{filename} - {caption}\n")
...
#         # Check if video_caption is None before trying to split
#         if video_caption is None:
#             print("Error: video_caption is None.")
#             continue
